package com.open.common.core.constant;
...
public interface CacheConstants {
	 ...
	 * oauth 缓存前缀
	 */
	String PROJECT_OAUTH_ACCESS = "open_oauth:access:";
	 ...
	 * oauth 客户端信息
	 */
	String CLIENT_DETAILS_KEY = "open_oauth:client:details";
