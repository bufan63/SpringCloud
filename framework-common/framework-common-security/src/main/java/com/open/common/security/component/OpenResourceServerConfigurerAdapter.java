 ...
 */
@Slf4j
public class OpenResourceServerConfigurerAdapter extends ResourceServerConfigurerAdapter {
	@Autowired
	...
	public void configure(ResourceServerSecurityConfigurer resources) {
		...
		UserAuthenticationConverter userTokenConverter = new OpenUserAuthenticationConverter();
